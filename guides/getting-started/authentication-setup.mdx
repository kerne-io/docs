...
- [Gating features](/guides/billing/enforcing-limits-without-breaking-ux) — where to check access
- [Registration modes](/concepts/identity/registration-modes) — who is allowed to sign up
