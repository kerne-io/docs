Oui — les ` ``` ` à l’intérieur cassaient le fence. Voici le guide **Usage billing end-to-end** avec un fence externe à 4 backticks pour que tout le MDX reste intact :
