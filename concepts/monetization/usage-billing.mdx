...
| ---------------- | --------------------------------------------- | ------------------------------------------------------------------------- |
| **Allowance**    | One pool: 200 hours total, whoever burns them | 200 hours _per cutter_; A running out doesn't touch B                     |
...
The reason is simple: a spending cap is a promise you made about _your invoice_. Turning it into an outage would punish the customer for a promise you made to reassure them.
